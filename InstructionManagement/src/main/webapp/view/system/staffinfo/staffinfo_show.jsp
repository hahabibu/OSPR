...
<form action="" class="form-horizontal">
   	<div class="row">
    	<div class="col-sm-5 col-sm-offset-4">
        	<a href="${pageContext.request.contextPath }/system/staffinfo/updateStaffInfoUI.action?staffId=${staffInfo.staffId}" class="btn btn-success" >修改</a>
        	<a href="${pageContext.request.contextPath }/system/staffinfo/deleteStaffInfo.action?staffId=${staffInfo.staffId}" class="btn btn-success" >删除</a>
        	<a href="${pageContext.request.contextPath }/system/staffinfo/listStaffInfo.action" class="btn btn-waring" >返回上一级</a>
      </div>
    </div>
        	...
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<p class="form-control-static">
						<fmt:formatDate value="${staffInfo.staffBirthday}" pattern="yyyy年MM月dd日"/>
					</p>
                </div>
            </div>
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<p class="form-control-static">
						<fmt:formatDate value="${staffInfo.staffEntryTime}" pattern="yyyy年MM月dd日"/>
					</p>
                </div>
            </div>
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">备注信息</h5>
    	...
    	<div class="row">
        	...
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<p class="form-control-static">${staffInfo.staffNumber}</p>
                </div>
            </div>
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<p class="form-control-static">${staffInfo.staffPassword}</p>
                </div>
            </div>
        </div>
    </div>
