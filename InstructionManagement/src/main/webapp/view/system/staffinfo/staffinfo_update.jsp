...
<form action="${pageContext.request.contextPath }/system/staffinfo/updateStaffInfo.action" class="form-horizontal">
   	<div class="row">
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" value="${staffInfo.staffId }" readonly="readonly" name="staffId" class="form-control input-sm" placeholder="请输入编号"/>
                </div>
            </div>
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" value="${staffInfo.staffName }" name="staffName" class="form-control input-sm" placeholder="请输入姓名"/>
                </div>
            </div>
        </div>
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-5">
                	<input type="text" value="${staffInfo.staffAge}" name="staffAge" class="form-control input-sm" placeholder="请输入年龄"/>
                </div>
            </div>
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="email" name="staffEmail"  value="${staffInfo.staffEmail}" class="form-control input-sm" placeholder="请输入电子邮件"/>
                </div>
            </div>
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">备注信息</h5>
    	...
    	<div class="row">
        	...
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="staffNumber" value="${staffInfo.staffNumber}" class="form-control input-sm" placeholder="请输入账号 "  value="admin"/>
                </div>
            </div>
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                <input type="password" name="staffPassword"  value="${staffInfo.staffPassword}" class="form-control input-sm" value="admin123456" placeholder="请输入密码"/>
                </div>
            </div>
        </div>
    </div>
   	<div class="row">
    	<div class="col-sm-3 col-sm-offset-4">
        	<input  type="submit" class="btn btn-success" value="保存"/>
           	<a href="${pageContext.request.contextPath }/system/staffinfo/listStaffInfo.action" class="btn btn-success">返回上一级</a>
        </div>
    </div>
</form>
