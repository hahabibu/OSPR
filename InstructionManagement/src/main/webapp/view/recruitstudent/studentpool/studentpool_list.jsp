...
<body>
	...
	<form
		action="${pageContext.request.contextPath }/recruitstudent/studentpool/listStudentInfo.action"
		...
		<div class="row alert alert-info" style="margin: 0px; padding: 3px;">
			...
			<input
				...
				href="${pageContext.request.contextPath }/recruitstudent/studentpool/addStudentInfoUI.action">添加学员</a>
		...
		<div class="row" style="padding: 15px; padding-top: 0px;">
			<display:table class="table  table-condensed table-striped"
				...
				<display:column
					href="${pageContext.request.contextPath }/recruitstudent/studentpool/updateStudentInfoUI.action"
					paramId="studentId" paramProperty="studentId" value="修改" title="修改"></display:column>
				<display:column
					href="${pageContext.request.contextPath }/recruitstudent/studentpool/updateStudentType.action"
					paramId="studentId" paramProperty="studentId" title="领取学员"
					value="领取学员">
				</display:column>

				<display:column
					href="${pageContext.request.contextPath }/recruitstudent/studentpool/deleteStudentInfo.action"
