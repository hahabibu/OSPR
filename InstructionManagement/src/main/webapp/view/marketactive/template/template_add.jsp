...
<form action="${pageContext.request.contextPath }/marketactive/templateinfo/addTemplateInfo.action" class="form-horizontal">
   	...
   	<div class="row">
    	<div class="col-sm-3 col-sm-offset-4">
        	<input  type="submit" class="btn btn-success" value="保存"/>
              ...
              <a class="btn btn-warning" href="${pageContext.request.contextPath }/marketactive/template/listTemplateInfo.action">返回上一级</a>
        </div>
    </div>
</form>
