...
<form action="${pageContext.request.contextPath }/student/evaluationinfo/updateEvaluationInfo.action" method="post" class="form-horizontal">
                ...
                <div class="col-sm-9">
                	...
                	<select name="evaluationTile">
                		...
                		<c:forEach var="evaluationTitle" items="${ evaluationTitle_map}">
                			<option value="${evaluationTitle.key }" ${evaluationTitle.key==evaluationInfo.evaluationTile?'selected':'' }>${evaluationTitle.key }</option>
                		</c:forEach>
                	</select>
                </div>
                </div>
    ...
    <div class="row">
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
               			<input type="text" name="evaluationTime" value='<fmt:formatDate value="${evaluationInfo.evaluationTime}"/>' class="form-control input-sm" placeholder="请输入评价时间"/>
                </div>
            </div>
        </div>
