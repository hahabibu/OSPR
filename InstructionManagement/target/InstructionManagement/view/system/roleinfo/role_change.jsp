...
<form action="${pageContext.request.contextPath }/system/roleinfo/roleChange.action" class="form-horizontal">
    ...
    <!-- 结束3 -->
   	<div class="row">
    	<div class="col-sm-5 col-sm-offset-4">
            ...
            <a class="btn btn-warning" href="${pageContext.request.contextPath }/system/roleinfo/listStaffRoleInfo.action">返回上一级</a>
