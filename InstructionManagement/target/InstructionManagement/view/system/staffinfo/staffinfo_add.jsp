...
<form action="${pageContext.request.contextPath }/system/staffinfo/addStaffInfo.action" class="form-horizontal">
   	<div class="row">
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="staffBirthday" readonly="readonly" onclick="WdatePicker()" class="form-control input-sm" placeholder="请输入出生日期"/>
                </div>
            </div>
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="email" name="staffEmail" class="form-control input-sm" placeholder="请输入电子邮件"/>
                </div>
            </div>
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="staffEntryTime" readonly="readonly" onclick="WdatePicker()" class="form-control input-sm" placeholder="请输入入职时间 "/>
                </div>
            </div>
