...
<body>
	...
	<form
		action="${pageContext.request.contextPath }/recruitstudent/auditioninfo/updateAuditionInfo.action"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="auditionCourse"
							value="${auditionInfo.auditionCourse }"
					...
					<div class="col-sm-9">
						<select id="studentId" name="studentId"
							...
							<c:forEach var="student" items="${student_list }">
								<option value="${student.studentId }" ${student.studentId==auditionInfo.studentId?'selected':'' }>${student.studentName }
								</option>
							</c:forEach>
						</select>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="auditionTime" onclick="WdatePicker()"
							value='<fmt:formatDate value="${auditionInfo.auditionTime}" />'
