...
<body onload="loadData()">
	...
	<form id="studentInfo" name="studentInfo" onsubmit="return doSubmit()"
		action="${pageContext.request.contextPath }/recruitstudent/studentpool/updateStudentInfo.action"
		method="post" class="form-horizontal">
		<div class="row">
			<div class="col-sm-3 col-sm-offset-4">
				<input type="submit" class="btn btn-success" value="修改" /> <a
					class="btn btn-warning"
					href="${pageContext.request.contextPath }/recruitstudent/studentpool/listStudentInfo.action">返回上一级</a>
			</div>
		</div>
